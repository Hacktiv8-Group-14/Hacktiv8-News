...
export default function HeadlineCard ({image, title, description, url, index, setIndex}) {
    ...
    return (
        <div className="w-11/12 relative text-white">
            ...
            <Button className="absolute inset-y-0 left-0 ml-5  hover:opacity-50"><HiArrowCircleLeft size={50}  onClick={onClickleft}/></Button>
            <Button className="absolute inset-y-0 right-0 mr-5 hover:opacity-50 "><HiArrowCircleRight size={50}  onClick={onClickRight}/></Button>
